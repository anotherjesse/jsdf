...
return sphere(1.5).union(s.orient(X), s.orient(Y), s.orient(Z), { k: 1 }).scale(10);`,
...
return f.translate([0, 0, -1.1]).scale(10);`,
...
const radial = box([2.6, 2.6, 0.18])
  ...
  .translate([1.8, 0, 0]);
return union(twisted, bent, radial).scale(10);`,
...
return union(columns, roof, lantern).scale(10);`,
