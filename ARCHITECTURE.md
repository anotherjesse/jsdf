...
- `editor-check.html` checks Monaco/source-link/editor integration behavior; `src/verify/editor-tooling-runtime.ts` owns the API hint, signature help, diagnostics, prettify, auto-return, preferences, and quick-fix verifier fixtures used by that page
